...
\label{sec:classical}
 ...
 Depois desse processo uma etapa de treinamento utilizando conjunto de treinamento integralmente é realizado. O classificador SVM foi implementado utilizando a biblioteca Scikit-Learn \cite{scikit-learn}.

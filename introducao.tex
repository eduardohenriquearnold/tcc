...
\section{Métodos de detecção de objetos}
	...
	\vfill
	\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{diagram/system}
	\end{frame}

	\begin{frame}[b]{Utilizando aprendizado de representação}
	\begin{enumerate}
	...
	\vfill
	\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{diagram/system-deep}
	\end{frame}

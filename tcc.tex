...
% Preâmbulo
\titulo{Técnicas de aprendizado de máquina para detecção de pessoas em ambiente industrial}
...
%\chapter{Localização e classificação utilizando aprendizado profundo}
%\chapter{Conclusão}
\end{document}

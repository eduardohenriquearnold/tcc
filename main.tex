...
\title{Human detection in industrial environment using depth images and deep classifier}
\title{Human detection in industrial environment:\\ a comparison between traditional and \\deep learning methods}
